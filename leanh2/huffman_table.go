// Code generated from RFC 7541 Appendix B. DO NOT EDIT.

package leanh2

// huffCode/huffBits are the canonical Huffman codes of RFC 7541 Appendix B:
// per symbol (0..255) the code and its length in bits. Symbol 256 is EOS
// (30 bits, all ones) and is deliberately NOT in the table — EOS inside a
// literal is an error per §5.2, and padding may only be a prefix of it.
